...
class _SurroundViewState extends State<SurroundView> {
  ...
  void didUpdateWidget(SurroundView old) {
    ...
    if (_loaded) {
      ...
      final json = jsonEncode(objs);
      _wv.runJavaScript("updateDrive(${widget.speed.toStringAsFixed(1)},${widget.steeringAngle.toStringAsFixed(1)},$json)");
    }
  }
    ...
    return Container(
      ...
      child: Stack(
        children: [
          ...
          // HUD overlay — speed, gear, battery (on top of 3D)
          ...
          Positioned(top: 12, right: 14, child: Container(
            ...
            child: Row(children: [
              ...
              Icon(Icons.battery_std, size: 14,
                color: widget.batteryLevel > 30 ? const Color(0xFF34D399) : const Color(0xFFEF4444)),
